...
struct PXPointsAndDiscounts: Decodable {
    ...
    init(points: PXPoints?, discounts: PXDiscounts?, crossSelling: [PXCrossSellingItem]?, viewReceiptAction: PXRemoteAction?, topTextBox: PXText?, customOrder: Bool?, paymentSplit: PXExpenseSplit?) {
        self.points = points
    ...
    init(from decoder: Decoder) throws {
        ...
        let paymentSplit: PXExpenseSplit? = try container.decodeIfPresent(PXExpenseSplit.self, forKey: .paymentSplit)
