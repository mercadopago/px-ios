...
class TotalPayerCostRowTableViewCell: UITableViewCell {
    ...
    public func fillCell(total: Double) {
        ...
        let attributedTotal = NSMutableAttributedString(attributedString: NSAttributedString(string: "Total".localized_temp + ": ", attributes: [NSForegroundColorAttributeName: UIColor.black]))
