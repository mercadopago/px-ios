...
open class SecurityCodeViewController: MercadoPagoUIViewController, UITextFieldDelegate {
    ...
    func setupInputAccessoryView() {
        ...
        let buttonNext = UIBarButtonItem(title: "card_form_next_button".PXLocalized, style: .plain, target: self, action: #selector(self.continueAction))
        let buttonPrev = UIBarButtonItem(title: "card_form_previous_button".PXLocalized, style: .plain, target: self, action: #selector(self.backAction))
