   ...
   open
    ...
    func setupInputAccessoryView() {
        ...
        if self.toolbar == nil {
            ...
            let buttonNext = UIBarButtonItem(title: "card_form_next_button".PXLocalized, style: .plain, target: self, action: #selector(CardFormViewController.rightArrowKeyTapped))
            let buttonPrev = UIBarButtonItem(title: "card_form_previous_button".PXLocalized, style: .plain, target: self, action: #selector(CardFormViewController.leftArrowKeyTapped))
