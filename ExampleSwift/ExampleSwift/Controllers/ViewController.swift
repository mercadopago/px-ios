...
class ViewController: UIViewController {
    ...
    @IBAction func launchCongrats(_ sender: Any) {
        ...
        _ = PXPaymentCongrats()
            ...
            .withPaymentMethodInfo(PXPaymentInfo(amount: "Amount", transactionAmount: "transactionAmount", paymentMethodName: "Mastercard", paymentMethodLastFourDigits: "1234", paymentMethodExtraInfo: "Some extra info", paymentMethodId: "visa", paymentMethodType: .CREDIT_CARD, hasInstallments: true, installmentsRate: 52.3, installmentsCount: 0, installmentAmount: "$ 430", hasDiscount: true, discountName: "Bonificacion for fachero"))
