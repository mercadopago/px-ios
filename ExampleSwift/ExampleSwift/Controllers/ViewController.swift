...
class ViewController: UIViewController {
    ...
    @IBAction func launchCongrats(_ sender: Any) {
        ...
        _ = PXPaymentCongrats()
            ...
            .shouldShowInstructionView(true)
            ...
            .withPaymentMethodInfo(PXPaymentInfo(paidAmount: "$100", transactionAmount: "$1000", paymentMethodName: "Mastercard", paymentMethodLastFourDigits: "1234", paymentMethodExtraInfo: "Mercado Pago Wallet", paymentMethodId: "master", paymentMethodType: .CREDIT_CARD, hasInstallments: false, installmentsRate: 52.3, installmentsCount: 0, installmentAmount: "$430", hasDiscount: true, discountName: "70% OFF"))
