...
- (IBAction)launchCongrats:(id)sender {
    PXPaymentCongrats *congratsData = [[[[[[[[[[[[[PXPaymentCongrats alloc] init]
        ...
        NSLog(@"Tuve un problema");
                                         ...
                                         withCrossSellingWithCrossSellingItems:@[[[PXCrossSellingItem alloc] initWithTitle:@"Gane 200 pesos por sus pagos diarios" icon:@"https://mobile.mercadolibre.com/remote_resources/image/merchengine_mgm_icon_ml?density=xxhdpi&locale=es_AR" contentId:@"cross_selling_mgm_ml" action: [[PXRemoteAction alloc] initWithLabel: @"Invita a más amigos a usar la aplicación" target: @"meli://invite/wallet"]]]]
