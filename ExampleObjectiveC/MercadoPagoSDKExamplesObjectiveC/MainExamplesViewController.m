...
- (IBAction)launchCongrats:(id)sender {
    PXPaymentCongrats *congratsData = [[[[[[[[[[[[PXPaymentCongrats alloc] init]
                                        ...
                                        withTrackingWithTrackingProperties:[[PXPaymentCongratsTracking alloc] initWithPaymentStatus:@"APPROBED" paymentStatusDetail:@"Because yes" totalAmount:55 paymentId:@"123" currencyId:@"pesos"] trackingConfiguration: [[PXTrackingConfiguration alloc] initWithTrackListener:self flowName:@"testAPP objc" flowDetails:nil sessionId:nil]]
