...
- (IBAction)launchCongrats:(id)sender {
    PXPaymentCongrats *congratsData = [[[[[[[[[[[[PXPaymentCongrats alloc] init]
                                                withCongratsType:PXCongratsTypeAPPROVED]
                                        ...
                                        withTrackingWithTrackingProperties:[[PXPaymentCongratsTracking alloc] initWithCampaingId: nil currencyId:@"ARS" paymentStatusDetail:@"The payment has been approved succesfully" totalAmount:[[NSDecimalNumber alloc] initWithInt:123] paymentId:@"123"] trackingConfiguration: [[PXTrackingConfiguration alloc] initWithTrackListener:self flowName:@"testAPP objc" flowDetails:nil sessionId:nil]]
