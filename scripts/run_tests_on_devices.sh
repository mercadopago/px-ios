...
xcodebuild clean test -project MercadoPagoSDK.xcodeproj -scheme MercadoPagoSDKTests -destination "platform=iOS Simulator,name=iPhone SE,OS=10.2" CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED=NO ONLY_ACTIVE_ARCH=NO -quiet
